...
public class ShellSortDemo {
	 ...
	 * On my system, Shell Sort took about 42 millis to sort 100,000 records,
	 * while insertion sort takes about over 8 seconds to do the same.
	 */
	public static void main(String[] args) {
		...
		new InsertionSort(data2).sort(); // InsertionSort was implemented earlier, calling it to compare with Shell Sort
